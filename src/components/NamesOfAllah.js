...
const NamesOfAllah = ({ onBack, onNameClick }) => {
  const namesOfAllah = [
    { title: 'The Most Merciful', name: 'Ar-Rahman' },
    { title: 'The Most Compassionate', name: 'Ar-Rahim' },
    { title: 'The Ever-Living', name: 'Al-Hayy' },
    { title: 'The Self-Subsisting', name: 'Al-Qayyum' },
    { title: 'Lord of all the Worlds', name: 'Rabb al-Alamin' },
    { title: 'The All-Knowing', name: 'Al-Alim' },
    { title: 'The One and Only', name: 'Al-Ahad' },
    { title: 'The Self-Sufficient Master', name: 'As-Samad' }
  ];
